...
import ca.vanzyl.harbor.client.okhttp.model.OverallHealthStatus;
...
public class HealthApi {
     ...
     */
    public com.squareup.okhttp.Call getHealthCall(String xRequestId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call getHealthValidateBeforeCall(String xRequestId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = getHealthCall(xRequestId, progressListener, progressRequestListener);
        return call;
    ...
    public ApiResponse<OverallHealthStatus> getHealthWithHttpInfo(String xRequestId) throws ApiException {
        com.squareup.okhttp.Call call = getHealthValidateBeforeCall(xRequestId, null, null);
     ...
     */
    public com.squareup.okhttp.Call getHealthAsync(String xRequestId, final ApiCallback<OverallHealthStatus> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getHealthValidateBeforeCall(xRequestId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<OverallHealthStatus>(){}.getType();
