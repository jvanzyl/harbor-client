...
import ca.vanzyl.harbor.client.okhttp.model.Search;
...
public class SearchApi {
     ...
     */
    public com.squareup.okhttp.Call searchCall(String q, String xRequestId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call searchValidateBeforeCall(String q, String xRequestId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = searchCall(q, xRequestId, progressListener, progressRequestListener);
        return call;
    ...
    public ApiResponse<Search> searchWithHttpInfo(String q, String xRequestId) throws ApiException {
        com.squareup.okhttp.Call call = searchValidateBeforeCall(q, xRequestId, null, null);
     ...
     */
    public com.squareup.okhttp.Call searchAsync(String q, String xRequestId, final ApiCallback<Search> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = searchValidateBeforeCall(q, xRequestId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Search>(){}.getType();
