...
import ca.vanzyl.harbor.client.okhttp.model.ReplicationFilter;
import ca.vanzyl.harbor.client.okhttp.model.ReplicationTrigger;
...
public class ReplicationPolicy {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, description, srcRegistry, destRegistry, destNamespace, destNamespaceReplaceCount, trigger, filters, replicateDeletion, deletion, override, enabled, creationTime, updateTime);
  }
