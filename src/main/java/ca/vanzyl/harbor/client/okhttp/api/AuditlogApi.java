...
public class AuditlogApi {
     ...
     */
    public com.squareup.okhttp.Call listAuditLogsCall(String xRequestId, String q, String sort, Long page, Long pageSize, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call listAuditLogsValidateBeforeCall(String xRequestId, String q, String sort, Long page, Long pageSize, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = listAuditLogsCall(xRequestId, q, sort, page, pageSize, progressListener, progressRequestListener);
        return call;
    ...
    public ApiResponse<List<AuditLog>> listAuditLogsWithHttpInfo(String xRequestId, String q, String sort, Long page, Long pageSize) throws ApiException {
        com.squareup.okhttp.Call call = listAuditLogsValidateBeforeCall(xRequestId, q, sort, page, pageSize, null, null);
     ...
     */
    public com.squareup.okhttp.Call listAuditLogsAsync(String xRequestId, String q, String sort, Long page, Long pageSize, final ApiCallback<List<AuditLog>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = listAuditLogsValidateBeforeCall(xRequestId, q, sort, page, pageSize, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<AuditLog>>(){}.getType();
