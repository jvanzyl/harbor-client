...
import ca.vanzyl.harbor.client.okhttp.model.AdditionLinks;
...
import ca.vanzyl.harbor.client.okhttp.model.Reference;
import ca.vanzyl.harbor.client.okhttp.model.ScanOverview;
...
public class Artifact {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, type, mediaType, manifestMediaType, projectId, repositoryId, digest, size, icon, pushTime, pullTime, extraAttrs, annotations, references, tags, additionLinks, labels, scanOverview);
  }
